...
namespace PortalTI.Contratos.TJ.AlertaFimVigencia.Features.MonitoraJobFeature
{
    /// <summary>
    ...
    [Guid("be6e915a-feab-45f5-8493-d44bce185191")]
    public class MonitoraJobFeatureEventReceiver : SPFeatureReceiver
    {
        ...
        private const string List_JOB_NAME = "B2W-Contratos-Alerta-Vigencia";
